    ...
    <section id="why-choose-us" className="py-16 sm:py-24 bg-emerald-950 text-white scroll-mt-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <div className="w-12 h-1 bg-amber-450 mx-auto mt-4 rounded"></div>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {points.map((pt, idx) => (
            <div
              key={idx}
              className={`flex flex-col space-y-3 p-6 bg-emerald-900/40 border border-emerald-800/40 rounded-xl hover:bg-emerald-900/60 hover:border-amber-400/20 transition-all duration-300 shadow-sm ${
                dir === 'rtl' ? 'text-right items-end' : 'text-left items-start'
              }`}
            >
              <div className="p-2.5 bg-emerald-900 text-amber-400 rounded-lg w-fit">
                {pt.icon}
              </div>
